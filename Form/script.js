...
const validateInputs = () => {
  ...
  console.log(passwordDogrudurmu, "PASSWORD");
  console.log(dateDogrudurmu, "DATE");
  console.log(emailDogrudurmu, "EMAIL");
  console.log(adiDogrudurmu, "ADI");
  console.log(surnameDogrudurmu, "SURNAME");
  console.log(describeDogrudurmu, "DESCRIBE");
  console.log(ageDogrudurmu, "AGE");
  console.log(numberDogrudurmu, "NUMBER");
  console.log(zipDogrudurmu, "ZIP");
